...
import { getCarDetail, updateCarDetails, uploadFile } from "./UserFunctions";

class UpdateCarDetails extends Component {
    constructor(props) {
        super(props)
        ...
        this.state = {
            newCar: {
                "VehicleNumber": props.match.params.id
            },
        ...
        getCarDetail(this.state.carId)
            .then(json => {
                ...
                if (Array.isArray(json)) {
                    ...
                    newCar.VehicleModel = json[0].VehicleModel
                    newCar.VehicalPicture = json[0].VehicalPicture
                    newCar.VehicleYear = json[0].VehicleYear
                    newCar.VehicalType = json[0].VehicalType
                    newCar.RentalVehicalCapacity = json[0].RentalVehicalCapacity
                    newCar.HrRentalPrice = json[0].HrRentalPrice
                    newCar.VehicleCondition = json[0].VehicleCondition
                    newCar.CurrentMileage = json[0].CurrentMileage
                    newCar.RegistrationTag = json[0].RegistrationTag
                    newCar.LastServicedDate = json[0].LastServicedDate
                    newCar.RentalLocationName = json[0].RentalLocationName
                    newCar.RentalAddress = json[0].RentalAddress
                    newCar.LateReturnFee = json[0].LateReturnFee
                    this.setState({
    ...
    onSubmit() {
        this.uploadFile();
        updateCarDetails(this.state.newCar)
            .then(json => {
                console.log(json);
    ...
    uploadFile() {
        ...
        if (files.length > 0) {
            ...
            console.log("VehicalPicture", files[0].name)
            this.setState({
                newCar: newCar
            })
            uploadFile(files[0])
                    ...
                    <Card.Body>
                        ...
                        <Form>
                            ...
                            <Form.Group controlId="serviceDate">
                                ...
                                <Form.Control type="text" placeholder="Enter Last Service Date" value={this.state.LastServicedDate} onChange={this.updateLastServicedDate} />
                                <Form.Control.Feedback type="invalid">
                            ...
                            <Form.Group controlId="lateFees">
                                ...
                                <Form.Control required="true" type="number" placeholder="Enter Late Return Fees" value={this.state.LateReturnFee} onChange={this.updateLateFees}/>
                                <Form.Control.Feedback type="invalid">
